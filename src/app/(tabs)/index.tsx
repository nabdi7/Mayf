...
import {Clock, ClockComp} from '../../components/Clock';
...
export class PrayerTimesScreen extends Component<{navigation:any},{}> {
  ...
  render() {
      ...
      <ImageBackground source={require('../../resources/imgs/abuLogo.png')} resizeMode='contain' imageStyle={{top:'8%'}} style={{width: '100%', height: '100%', backgroundColor:'#2E4B82'}}>
              ...
              <View style={{flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'#2E4B82'}}>
                <Text style={{fontSize:30, color:'white', fontWeight:'bold'}}>Prayer Times</Text>
              </View>
      </ImageBackground>
      )
  }
